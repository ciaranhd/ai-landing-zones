...
from ml_product_1.domain.models import CreditApplication
from ml_product_1.domain.models import CreditApplication, RiskAssessment
from ml_product_1.domain.ports import ModelFn 
from ml_product_1.adaptors.ml_model.sk_forest.config import RandomForestConfig
